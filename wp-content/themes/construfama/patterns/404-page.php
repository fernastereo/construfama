...
return array(
    'title'      =>__( '404 Page', 'architect-construction' ),
...
<p class="has-text-align-center has-content-heading-font-size"><strong>'. esc_html('Unfortunately we can’t find that page.','architect-construction') .'</strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">'. esc_html('The page you are looking for doesnt exist or has been moved. Try another url or go to the site homepage.','architect-construction') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->',
);